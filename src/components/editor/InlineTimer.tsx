...
function seedDrafts(value: number | undefined): { mm: string; ss: string } {
...
/**
 * Click-to-edit timer cell. Renders "m:ss" by default, swaps to two digit-only
 * inputs (MM and SS) on click. Commits on Enter or blur outside; reverts on Escape.
 */
